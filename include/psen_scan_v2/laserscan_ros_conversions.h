                                      ...
                                      const ros::Time& timestamp = ros::Time::now())
{
  ...
  ros_message.header.frame_id = prefix + configuration::constants::SCAN_FRAME_ID_SUFFIX;
  ...
  ros_message.time_increment =
      configuration::constants::TIME_PER_SCAN_IN_S / (2 * M_PI) * laserscan.getScanResolution().toRad();

  ros_message.scan_time = configuration::constants::TIME_PER_SCAN_IN_S;
  ros_message.range_min = configuration::constants::RANGE_MIN_IN_M;
  ros_message.range_max = configuration::constants::RANGE_MAX_IN_M;
