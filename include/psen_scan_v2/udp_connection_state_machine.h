...
using MonitoringFrameCallback = std::function<void(const monitoring_frame::MonitoringFrameMsg& msg)>;
...
struct udp_connection_state_machine_ : public msm::front::state_machine_def<udp_connection_state_machine_>
{
  ...
  struct events
  {
    ...
    {
      monitoring_frame_received(const monitoring_frame::MonitoringFrameMsg& frame) : frame_(frame) {}

      monitoring_frame::MonitoringFrameMsg frame_;
    };
