...
Publishes single scans from the PSENscan safety laser scanner. Scans that contain no measurement data are not published. This can occur for smaller scan ranges.
