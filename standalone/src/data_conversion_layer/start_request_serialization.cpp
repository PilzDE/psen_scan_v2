...
/**< Byte order: big endian */
  ...
  PSENSCAN_INFO("StartRequestSerialization",
                string("Serializing start request with angle_start=" + to_string(start) + ", angle_end=" +
                       to_string(end) + ", resolution=" + to_string(resolution) + " tenths of degree."));
