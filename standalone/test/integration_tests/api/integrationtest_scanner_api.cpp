...
static constexpr ScanRange SCAN_RANGE{ util::TenthOfDegree(0), util::TenthOfDegree(60) };
...
protected:
  ...
  ScannerV2 scanner_{ config_, std::bind(&UserCallbacks::LaserScanCallback, &user_callbacks_, std::placeholders::_1) };
};
