...
{
  return ExplainMatchResult(ContainerUnorderedEq(io_state.physicalInput()), arg.physicalInput(), result_listener) &&
         ExplainMatchResult(ContainerUnorderedEq(io_state.logicalInput()), arg.logicalInput(), result_listener) &&
