...
inline io::PinData readIOField(const std::array<uint8_t, ARRAY_SIZE> hex_dump, const size_t offset_io_field)
{
  ...
  io_pin_data.physical_input_0 = io::deserializePinField(ss, 10, io::createInputPinState);

  raw_processing::read<std::array<uint8_t, 4>>(ss);
  io_pin_data.physical_input_1 = io::deserializePinField(ss, 10, io::createInputPinState);

  raw_processing::read<std::array<uint8_t, 4>>(ss);
  io_pin_data.physical_input_2 = io::deserializePinField(ss, 10, io::createInputPinState);
...
0x38, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // 0060
...
public:
  const std::array<uint8_t, 105> hex_dump = {
    0x00, 0x00, 0x00, 0x00, 0xca, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00,
    0xdc, 0x05, 0x0a, 0x00,  // End of FixedFields
    0x01, 0x3f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // IO states
    0x02, 0x05, 0x00, 0xfc, 0x61, 0x06, 0x00,                                                        // Scan counter
    0x05, 0x00, 0x00,                                                                                // Measurements
    0x09, 0x00, 0x00, 0x00                                                                           // End of Frame
  };
